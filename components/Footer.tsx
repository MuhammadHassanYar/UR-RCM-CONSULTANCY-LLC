...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-slate-950 text-slate-300 border-t border-slate-800 relative overflow-hidden" aria-labelledby="footer-heading">
      <h2 id="footer-heading" className="sr-only">Footer</h2>

      {/* Top Banner inside footer */}
      <div className="w-full border-b border-slate-800/80 bg-slate-900/50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="w-full sm:w-auto flex items-center shrink-0">
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#0066CC] hover:bg-[#0052A3] text-white text-xs sm:text-sm font-bold shadow-lg shadow-blue-900/30 transition-all text-center"
            >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-5 min-w-0 max-w-full">
            <div className="bg-white/5 p-3 sm:p-3.5 rounded-2xl inline-block border border-white/10 backdrop-blur-sm max-w-full">
              <Logo theme="dark" />
            </div>
            ...
            <div className="pt-2 text-xs text-slate-400 flex items-center gap-2 min-w-0">
              <span className="w-2 h-2 rounded-full bg-[#00A859] animate-pulse shrink-0" />
              <span className="min-w-0 flex-1">Processes designed with healthcare privacy & security standards</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-4 min-w-0 max-w-full">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-xs text-slate-400 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left min-w-0 max-w-full">
