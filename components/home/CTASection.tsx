...
export function CTASection() {
  ...
  return (
    <section id="cta-section" className="w-full py-16 sm:py-20 lg:py-28 bg-[#070b14] text-white relative overflow-hidden border-t border-slate-800">
      {/* Subtle Abstract Data-Flow Background */}
      <div className="absolute inset-0 bg-tech-grid opacity-30 pointer-events-none" />
      
      {/* Flowing Gradient Beams */}
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-full max-w-4xl h-72 sm:h-96 bg-gradient-to-b from-[#0066CC]/20 via-[#00A859]/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 right-1/4 w-full max-w-xl h-64 bg-blue-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main CTA Card Frame */}
        <div className="w-full max-w-4xl mx-auto rounded-2xl sm:rounded-3xl bg-slate-900/90 border border-white/10 p-5 sm:p-12 lg:p-16 shadow-2xl backdrop-blur-md text-center relative z-10 min-w-0">
          ...
          {/* Heading */}
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-snug mb-4 break-words">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-[#0066CC] hover:bg-[#0052A3] text-white font-bold text-sm shadow-xl shadow-blue-600/30 hover:shadow-blue-600/40 transition-all group text-center"
            >
            ...
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/15 text-white font-semibold text-sm transition-colors backdrop-blur-xs text-center"
            >
          ...
          <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 text-xs text-slate-400 text-center">
